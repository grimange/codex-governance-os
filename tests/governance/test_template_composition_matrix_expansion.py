...
class TemplateCompositionMatrixExpansionTests(unittest.TestCase):
    supported_cases = (
        [],
        ["django", "monorepo"],
        ["service", "monorepo"],
    ...
    def test_expanded_supported_matrix_is_admitted_everywhere(self) -> None:
    ...
    def test_rejection_matrix_remains_fail_closed_after_expansion(self) -> None:

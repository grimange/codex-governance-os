...
The twice-expanded matrix remains aligned across:
...
- drift detection and protection suites
...
No rejected composition was admitted accidentally after the `service + monorepo` promotion.

...
- Run `python tools/governance/continuity_harness.py --run-scenarios` when you need the executable continuity harness for the canonical multi-session scenario fixtures.
